...
const ghRecipeData: Recipe[] = [
  ...
  {
    name: "Produce Fruit", production_time: 480,
    products: new Map([["Fruit", 100]]),
    ingredients: new Map([["Fertility", 0.81]])
  },
  {
    name: "Produce Sugar Cane", production_time: 540,
